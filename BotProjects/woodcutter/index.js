...
function dropLog(){
    ...
    var drop_y = 1176;
    var log_colour = "6f5532";
    var pixel_color = robot.getPixelColor(inventory_x, inventory_y);
    console.log("Inventory log colour is: " + pixel_color);
...
function findTree(){
    ...
    var width = 1650;
    var height = 820;
    var treeColours = ["82633a", "85663b", "7f6038","87683d","8A6a3e","#8e6c40","#795c35"];
    ...
    for(var i = 0; i < 100; i++){
        ...
        if(treeColours.includes(screenshot)){
            var screen_x = random_x + x;
            var screen_y = random_y + y;
            
            if(confirmTree(screen_x, screen_y)){
                console.log("Found tree at: " + screen_x + ", " + screen_y + " colour " + screenshot);
                return {x: screen_x, y:screen_y};
            }else{
                console.log("Unconfirmed tree at: " + screen_x + ", " + screen_y + " colour " + screenshot);
            }
